  ...
  - title: 'DocSearch: The easiest way to add search to your documentation'
    ...
    authors:
      - name: Tim Carry
        ...
        avatar: /api/avatar/twitter/pixelastic
    slides:
  ...
  - title: Five minutes before prod
    ...
    authors:
      - name: Xavier Durand
        ...
        avatar: /api/avatar/twitter/xavedurand
    slides: []
    links: []
    videos: []
  - title: 'JavaScript, Unicode and the Emoji family'
    ...
    authors:
      - name: Stefan Judis
        ...
        avatar: /api/avatar/twitter/stefanjudis
    slides:
      - >-
  ...
  - title: "Stop wasting your users' time, make them happy"
    ...
    authors:
      - name: Nicolas Boutin
        ...
        avatar: /api/avatar/twitter/BoutinNico
    slides:
      - >-
  ...
  - title: Understanding REST APIs in 5 Simple Steps
    ...
    authors:
      - name: Tessa Mero
        ...
        avatar: /api/avatar/twitter/TessaMero
    slides:
      - >-
